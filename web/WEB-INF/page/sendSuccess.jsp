        ...
        <div class="service_box1">
            <div class="container" align="center">
                <ul class="about_links">
                    <li>发送方：${command.sendid}</li>
                    <li>接收方：${command.receid}</li>
                    <li>标题：${command.title}</li>
                    <li>内容：${command.content}</li>
                    <li>时间：<fmt:formatDate value="${command.sendtime}" pattern="yyyy-MM-dd HH:mm:ss"/></li>
                </ul>
            </div>
        </div>
    </div>
