...
public class SendmailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "1332867219@qq.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "zuzynqjrsiykhjab";
    ...
    public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
        ...
        msg.setFrom(new InternetAddress(myEmailAccount,"管理员", "UTF-8"));
